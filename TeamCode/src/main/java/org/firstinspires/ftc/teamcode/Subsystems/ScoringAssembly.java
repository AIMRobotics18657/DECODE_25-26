...
public class ScoringAssembly {
    ...
    private static final double SHOOT_THREE_MS = 300;
    private static final double SHOOT_TWO_MS = 200;
    private static final double SHOOT_ONE_MS = 100;
    private boolean shootingThree = false;
    private boolean shootingTwo = false;
    private boolean shootingOne = false;
