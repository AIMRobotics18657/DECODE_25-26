...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3410.8263; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2400.2111; // x position of the perpendicular encoder (in tick units)
    }
...
//        driver.setOffsets(mmPerTick * PARAMS.parYTicks, mmPerTick * PARAMS.perpXTicks, DistanceUnit.MM);
        ...
        driver.setOffsets(73.025, -60.325, DistanceUnit.MM);
